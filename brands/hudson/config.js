...
window.BRAND = {
  ...
  hero: {
    ...
    creatorAlt: 'Hudson',
    creatorPhoto: './brands/hudson/assets/_placeholder-influencer.png',  // desktop (vertical 3:4)
    creatorBanner: './brands/hudson/assets/_placeholder-banner.png',     // mobile (horizontal)
