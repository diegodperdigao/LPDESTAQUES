...
window.BRAND = {
  ...
  form: {
    ...
    fields: [
      ...
      { id: 'contato', label: 'Nome de usuário Betano', type: 'text',
        autocomplete: 'off', placeholder: 'Seu nome de usuário Betano',
        noEmail: 'Aqui vai o seu nome de usuário Betano, não o e-mail. Seu e-mail você coloca no campo E-mail acima.',
        help: {
          link: 'Onde encontrar?',
          title: 'Onde encontrar seu nome de usuário Betano',
  ...
  links: {
    ...
    whatsapp: 'https://api.wapsync.com.br/r/vipnobru'    // grupo de WhatsApp (destino final)
  },
