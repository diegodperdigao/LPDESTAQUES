...
window.BRAND = {
  ...
  direct: {
    ...
    popup: {
      ...
      text: 'Rápido e gratuito: crie sua conta na Betano em cerca de 1 minuto (abre em nova aba). Volte aqui, finalize e pronto — você libera o acesso completo ao grupo.',
