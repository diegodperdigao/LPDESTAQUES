...
// Meta Pixel (base + PageView). Só injeta se a marca tem pixel.id configurado.
// O evento de conversão (5000+ -> criar conta) é disparado pelo engine.js.
const pixelId = B.pixel?.id || '';
const pixelSnippet = pixelId ? `<!-- Meta Pixel -->
<script>
